...
| 存储治理 | 依次读 `data/programs/storage_governance_goal.yaml`、`data/registry/external_projects.yaml`、`governance/adapters/storage_governance.yaml`，再按适配器进入专用 router 与唯一执行 `STATE.yaml` |
